 ...
 * @return void
 */
function _wp_ban_manually_load_plugin() {
	require dirname( __DIR__ ) . '/wp-ban.php';
}
tests_add_filter( 'muplugins_loaded', '_wp_ban_manually_load_plugin' );
...
class_alias( 'WP_Ban_TestCase', 'Plugin_TestCase' );
